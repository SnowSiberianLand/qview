...
def get_rds_version(conn):
    ...
    sql = "SELECT VNUM1, VNUM2, VNUM3, VDATE from RDS_VERSION order by VNUM1, VNUM2, VNUM3"
    ...
    if (res==False):
        print("table RDS_VERSION isn't exist")
        return None

    nrow = vtbl.rowCount()
    if (nrow==0):
        print("table RDS_VERSION is empty")
        return None        
